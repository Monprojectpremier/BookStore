...
import com.bookstore.domain.Response;
...
import com.bookstore.service.impl.StripeService;
...
public class CheckoutController {
	...
	public @ResponseBody Response createCharge(String name, String email, String token, int amount) {
		
		
		System.out.println("chargeee "+email+token+amount);
		...
		String chargeId = stripeService.createCharge(name, email, token, amount * 100);// 9.99 usd
